...
export function Header() {
  const { isLoggedIn, userData, connect, disconnect } = useWallet();
          ...
          <div className="flex items-center">
            {isLoggedIn && userData ? (
              <div className="flex items-center gap-4">
                <div className="hidden sm:block px-4 py-2 bg-lucky-dark/50 rounded-lg border border-lucky-border text-sm font-mono text-lucky-orange">
